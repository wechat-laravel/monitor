...
//创建分组
Route::get('/wechat/crup/{name}','Wechat\UsersController@crup');
//修改分组
Route::get('/wechat/upup/{groupId}/name/{name}','Wechat\UsersController@upup');
//删除分组
Route::get('/wechat/deup/{groupId}','Wechat\UsersController@deup');
//移动单个用户到指定分组
Route::get('/wechat/mvup/{opendId}/group/{groupId}','Wechat\UsersController@mvup');
//批量移动用户到指定分组
Route::get('/wechat/mvups/{opendIds}/group/{groupId}','Wechat\UsersController@mvups');
//标签列表
